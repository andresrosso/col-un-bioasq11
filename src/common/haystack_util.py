...
def evaluate_batch_list(test_batch_docs, pipeline, pipeline_params, method_id, max_num_docs = 10, max_num_passages = 10):
    ...
    for i, batch_file in enumerate(test_batch_docs):
        ...
        doc_scores, passage_scores = evaluate_bioasq_phaseA_haystack_pipeline(test_batch_json, test_batch_filename, batch_file[0], pipeline, pipeline_params, method_id=method_id, max_num_docs=max_num_docs, max_num_passages=max_num_passages)
...
def evaluate_bioasq_phaseA_haystack_pipeline(batch_json, batch_json_fname, gold_json, pipeline, pipeline_params, method_id, max_num_docs=10, max_num_passages=10, is_eval=True): 
    submission = None
    ...
    submission_file_name = f'{working_folder}/{batch_json_fname}_model_{method_id}'
